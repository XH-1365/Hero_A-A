 ...
 * @LastEditTime: 2024-12-21 18:05:35
...
// 电机组3接收ID标识
typedef enum __DJI_Motor_Group3_RX_ID_enum
{
    DJI_MGRP3_M3508_RX_1, // 头正对自己右电机摩擦轮
    DJI_MGRP3_M3508_RX_2, // 头正对自己左电机摩擦轮
    DJI_MGRP3_RX_SUM
} DJI_Motor_Group3_RX_ID_enum;
